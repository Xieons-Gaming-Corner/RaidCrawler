namespace RaidCrawler.WinForms.SubForms
{
    partial class UpdateNotifPopup
    {
        ...
        /// </summary>
        /// <param name="disposing">true to dispose managed resources in addition to unmanaged resources; false to dispose only unmanaged resources.</param>
        ...
        /// <summary>
        /// Sets up and configures the UpdateNotifPopup form's controls, properties, and layout.
        /// </summary>
